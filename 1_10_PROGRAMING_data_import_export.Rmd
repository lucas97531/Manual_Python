...
data = pd.read_csv( 'data/diamonds.txt'
                   , sep = ',' # separator. Jest jeszcze jako alias pod nazwą 'delimiter'
                   , decimal = '.' # seprator dla ulamkow
                   , parse_dates = ['date']  # kolumny datowe ktore beda parsowane
                   , na_values = '' # braki danych
                   # na_values=[214.008,'',"blah"]  # braki danych jako lista
                   # na_values={'a':'bd', 'b':'nan'} # braki jako słownik gdzie specyfikujemy per kolumna
                   , date_parser = dateparse  # parser do dat
                   , thousands = ' ' # separator tysieczny
                   , encoding = 'windows-1252' # useful encodings: latin1, latin2, utf8, windows-1252
                   , converters = {'z':float})   # reczne wymuszanie typow kolumn
