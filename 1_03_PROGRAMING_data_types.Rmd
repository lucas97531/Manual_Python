...
# tekst dluosci 10 wyrownany do lewej z wypadowaniem zerami po prawej
print('{:0<10}'.format('abc'))

# tekst dluosci 10 wyrownany do prawej z wypadowaniem zerami po lewej
print('{:0>10}'.format('abc'))

# tekst dluosci 10 wyrownany do srodka z wypadowaniem zerami po obu stronach
print('{:0^10}'.format('abc'))
...
# liczba calkowita dluosci 10 z wypadowanymi zerami
print('{:010d}'.format(10))


# liczba ulamkowa z dwoma miejscami po przecinku
print('{:0>.2f}'.format(10.234))

# liczba ulamkowa dluosci 8+2 z wypadowanymi zerami po lewej stronie
print('{:0>8.2f}'.format(10.234))

# liczba ulamowa dluosci 8+2 z wypadowanymi zerami po prawej stronie
...
# format procentowy z jednym miejscem po przecinku
print('{:.1%}'.format(0.5))

# format walutowy
print('{:.2f}zl'.format(12.03))
...
# ciag liter
[chr(x) for x in range(97, 122)]  #  caly alfabet malymi literami
[chr(x).upper() for x in range(97, 123)] # caly alfabet wielkimi literami (pierwszy sposob)
[chr(x) for x in range(65, 90)] #caly alfabet wielkimi literami (drugi sposob)


# gotowe listy z literami i znakami:
from string import ascii_letters # lista z duzymi i malymi literami amerykanskimi
from string import printable  # lista ze znakami drukowanymi 
...
Uwaga: encodoewanie/dekodowanie możemy też używać na kolumnach DataFrames. Więce w chapterze o DataFrames. 
...
# 'r' na poczatku umozliwa nam podawanie sciezek z normalnymi slashami
