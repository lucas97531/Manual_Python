...
Fajny cheat sheet do Nympy <https://s3.amazonaws.com/assets.datacamp.com/blog_assets/Numpy_Python_Cheat_Sheet.pdf>
...
np.linspace(0,10,20) # 20 wartosci rozwno rozlozownych w przedziale 0-10.

np.eye(5) # macierz diagonrlna (dwuwymiarowa) o wymiarach 5x5 

np.random.rand(5,5) # macierz o wymiarach 5x5 z losowymi liczbami z rozkladu jednostajnego
...
Przydaje sie np. do wyszkukania k-najwiekszych wartosci. Albo pozycji k najwiekszych wartosci.

[link](https://kanoki.org/2020/01/14/find-k-smallest-and-largest-values-and-its-indices-in-a-numpy-array/)
