...
#(1) prosta funkcja z dwoma argumentami
def funkcja_1(a, b):
  return(a*b) 
...
#(3) funkcja z nieokreslono ilosci argumentow. Zakladamy ze argumenty NIE MUSZA byc ponazywane
...
#(4) funkcja z nieokreslono iloscia argumentow. Zakladamy ze argumenty MUSZA byc ponazywane
...
## przekazywanie argymentow przez slownik
...
-<b>Local(L)</b>: Defined inside function/class
-<b>Enclosed(E)</b>: Defined inside enclosing functions(Nested function concept)
-<b>Global(G)</b>: Defined at the uppermost level
-<b>Built-in(B)</b>: Reserved names in Python builtin modules

Buil-in > Global > Enclosed > Local
...
outer() # zwroci nam 'hello' bo modyfikacjia w f:inner wykonana na zmiennej nielokalnej i tym samym nadpisuje zmienna 'pi' w f:outer (enclosed scope)
print(pi)  # zwracam 'pi' z globalnej przestrzni (global scope)
...
print(foo) # foo przyjmie wartosc 'A' mimo ze nadpisanie bylo wykonanie w funkcji.
...
Wielokrotne wywolanie tej samej funkcji
