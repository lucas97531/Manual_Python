...
# konwersja na liste sloniow. Kazdy slownik to jedna kolumna
df.to_dict
...
df.select_dtypes(include=['float64']) # wybierz wszystkie kolumny typu 'float64'
...
df_w.assign(zarobek_plus_bonus = df_w['zarobek'] + df_w['bonusy']) # suma bosu i zarobkow
...
# przypladk ze splitem tekstu: patrz 'Praca z tekstem'
...
for group_name_i, group_i in grouped:
  print(name)
  print(group)
  group_name_i_df = pd.DataFrame(pd.group_vars, column = group_var)
  # obliczenia
  ....
...
#### stack - unstack
Odpowiedniki pivot/melt, ale zrobione po to aby dzialac na multiindeksach
```{r}
